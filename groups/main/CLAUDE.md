...
- [ ] Add a web console (read-only log viewer to start, full dashboard longer term — registered groups, message history, service status; SQLite DBs have everything needed)
