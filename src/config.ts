...
// Conservative input ceiling for the throwaway summariser — intentionally lower
// than the SDK's 165k auto-compact window since input is stripped user-visible
// messaging, not raw context, and should be small.
