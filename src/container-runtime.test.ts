...
describe('ensureContainerRuntimeRunning', () => {
  ...
  it('starts the runtime when status check fails', () => {
...
describe('cleanupOrphans', () => {
  it('uses container ls --format json to find orphans', () => {
    mockExecSync.mockReturnValueOnce('[]');
  ...
  it('skips non-running containers', () => {
    const jsonOutput = JSON.stringify([
      { status: 'stopped', configuration: { id: 'nanoclaw-group1-111' } },
